package com.qa.linkedin.listeners;
	...
	public class ExtentReportListener	 implements ITestListener{
		...
		public void onTestFailure(ITestResult result) {
			...
			//below one line getting the exception 			
			...
			try {
				...
				extentTest.get().fail("<b><font color=red>"+ "Screenshot on failure" +"</font></b>", MediaEntityBuilder.createScreenCaptureFromPath(path).build());
